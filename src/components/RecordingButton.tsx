      ...
      {!isRecording && !isProcessing && (
        ...
        >
          ...
          <div className="relative z-10">
            <Podcast className="h-36 w-36 text-white opacity-90 drop-shadow-[0_0_25px_rgba(168,85,247,0.9)] group-hover:drop-shadow-[0_0_35px_rgba(168,85,247,1)] transition-all duration-500" strokeWidth={1} />
          </div>
        </Button>
      )}
