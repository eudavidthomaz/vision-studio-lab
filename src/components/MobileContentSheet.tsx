  ...
  return (
    <Sheet open={open} onOpenChange={(v) => !v && onClose()}>
      <SheetContent
        side="bottom"
        className="
          h-[min(95svh,95dvh)] w-screen max-w-full p-0 rounded-t-2xl overflow-hidden
      ...
      >
        <div className="flex flex-col h-full w-full min-w-0 overflow-x-clip">
          ...
          <SheetHeader className="px-4 py-3 border-b sticky top-0 bg-background z-10 space-y-2">
            <SheetTitle className="text-base font-semibold line-clamp-2 text-left break-words">
              {content.title}
            </SheetTitle>
