...
export default function PostPreviewModal({ open, onOpenChange, content, onEdit, onSave }: PostPreviewModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      {/* Largura/altura sempre dentro da viewport; sem overflow lateral; layout em coluna */}
      <DialogContent className="w-[min(96vw,56rem)] max-w-none max-h-[90dvh] p-0 overflow-hidden rounded-lg">
        <div className="flex h-[min(90dvh,calc(100svh-4rem))] flex-col">
          ...
          {/* Conteúdo scrollável */}
          <div className="flex-1 overflow-y-auto px-3 sm:px-4 py-4 pb-[env(safe-area-inset-bottom)]">
            <Tabs defaultValue="instagram" className="w-full">
              ...
              <TabsContent value="instagram" className="space-y-4 mt-4">
                <div className="w-full sm:max-w-md mx-auto bg-background border rounded-lg overflow-hidden">
                  {/* Header */}
                  <div className="flex items-center gap-3 p-3 border-b">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-semibold text-sm truncate">Minha Igreja</p>
                  ...
                  {content.imagem_url ? (
                    <div className="aspect-square bg-muted">
                      <img src={content.imagem_url} alt={content.titulo} className="w-full h-full object-cover" />
                    </div>
                  ) : (
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <>
                          ...
                          <Button variant="ghost" size="sm" className="mt-2 h-7 px-2" onClick={handleStartEdit}>
              ...
              <TabsContent value="facebook" className="space-y-4 mt-4">
                <div className="w-full sm:max-w-2xl mx-auto bg-background border rounded-lg overflow-hidden">
                  {/* Header */}
                  <div className="flex items-center gap-3 p-4 border-b">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-semibold truncate">Minha Igreja</p>
                  ...
                  <div className="p-4">
                    {isEditing ? (
                      ...
                      <>
                        <p className="text-sm whitespace-pre-wrap break-words">{fullCaption}</p>
                        <Button variant="ghost" size="sm" className="mt-2 h-7 px-2" onClick={handleStartEdit}>
                          <Edit className="h-3 w-3 mr-1" />
                          Editar texto
                        </Button>
